...
interface Props {
  onClose: () => void;
  onCreated: (e: Evento) => void;
}

export default function ModalAgregarEvento({ onClose, onCreated }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-gray-200 border border-gray-300 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-5 bg-blue-100 border-b border-blue-200 rounded-t-2xl flex-shrink-0">
          <h2 className="text-[#0d0d0d] font-bold text-lg">Nuevo evento</h2>
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input name="nombre" type="text" required maxLength={200}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="costo" type="number" required min={0}
                className="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017]/50" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="hora" type="text" placeholder="09:00" maxLength={10}
                className="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017]/50" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input name="estado" type="text" maxLength={100} placeholder="Ej. Jalisco"
                className="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017]/50" />
            </div>
            <div>
              ...
              <input name="ciudad" type="text" maxLength={100} placeholder="Ej. Guadalajara"
                className="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017]/50" />
            </div>
          </div>
          ...
          <div>
            ...
            <input name="ubicacion" type="text" maxLength={200} placeholder="Ej. Polideportivo Norte"
              className="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017]/50" />
          </div>
